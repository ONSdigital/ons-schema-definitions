# -*- coding: utf-8 -*-
#
# EDC documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'EDC.tex', u'EDC Documentation',
     u'ONS Digital', 'manual'),
]
